            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="{{route('chat.update',$header->id)}}" method="post" data-parsley-validate>
                            @csrf
                            @method('put')
                            <div class="box-body">
                                <!-- Date dd/mm/yyyy -->
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="header" value="{{$header->header}}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control ckeditor" name="answer" required>{{$header->answer}}</textarea>
                                </div>
                                <!-- /.input group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_id" id="" class="form-control" required>
                                        ...
                                        @foreach($headers as $head)
                                            <option value="{{$head->id}}" {{$header->parent_id == $head->id ? "selected" : ""}} >{{$head->header}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="headerTranslations" value="{{$header->translation}}" data-role="tagsinput" style="width: 900px">
                                </div>
                                <!-- /.form group -->
                                <div class="form-group">
